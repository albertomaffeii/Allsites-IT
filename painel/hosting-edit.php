										...
										<form action="code.php" method="POST" class="form-control" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-md-3" style="background-color: #f8f9fa; height: 20vh;">
													...
													<label for="domain" class="form-label"><strong>Domain</strong>: <?=$service['domain'];?></strong></label>
													<input type="hidden" class="form-control" id="domainInfo" name="domainInfo" value="<?=$service['domain'];?>" />
													<br>
											...
											<div> 											
												<div class="col-md-6 mb-3">
													...
													<input type="submit" class="btn btn-primary" id="hosting_update" name="hosting_update" value="Update Service">
												</div>
											</div>
										</form>
									<?php 
